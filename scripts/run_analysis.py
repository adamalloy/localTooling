#!/usr/bin/env python3
"""
Run LLM analysis on an ingested meeting: per-statement topic/stance/grievance
extraction, then a whole-meeting summary with controversy/consensus detection.
...
def main() -> None:
    ...
    with session_scope() as db:
        n = analyze_meeting_statements(db, meeting_id)
        print(f"Analyzed {n} statement(s).")
